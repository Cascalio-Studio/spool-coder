...
class AnimatedProgressBar(QProgressBar):
    ...
    def __init__(self, parent=None):
        ...
        self.setFixedHeight(12)  # Slightly taller
...
class LogoWidget(QLabel):
    ...
    def __init__(self, parent=None):
        ...
        self.setFixedSize(80, 80)  # Reduced from 120x120
    ...
    def create_logo(self):
        ...
        if SVG_AVAILABLE:
            ...
            if os.path.exists(logo_path):
                try:
                    ...
                    pixmap = QPixmap(80, 80)  # Reduced from 120x120
        ...
        # Create gradient
        gradient = QLinearGradient(0, 0, 80, 80)  # Adjusted to new size
        gradient.setColorAt(0, QColor("#4FC3F7"))
        gradient.setColorAt(1, QColor("#29B6F6"))
        
        # Draw circle (adjusted for smaller size)
        painter.setBrush(QBrush(gradient))
        painter.setPen(Qt.PenStyle.NoPen)
        painter.drawEllipse(5, 5, 70, 70)  # Adjusted for smaller size
        
        # Add text
        painter.setPen(QColor("white"))
        font = QFont("Arial", 12, QFont.Weight.Bold)  # Reduced font size
...
class StartupScreen(QWidget):
    ...
    def setup_ui(self):
        ...
        frame_layout.setContentsMargins(40, 40, 40, 40)  # Larger margins
        frame_layout.setSpacing(20)  # More spacing
        ...
        font = QFont("Arial", 22, QFont.Weight.Bold)  # Slightly larger again
        self.app_name_label.setFont(font)
        self.app_name_label.setStyleSheet("color: #2E3440; margin: 10px 0px;")
        frame_layout.addWidget(self.app_name_label)
        
        # Subtitle
        self.subtitle_label = QLabel("Bambu Lab NFC Tool")
        self.subtitle_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        font = QFont("Arial", 12)  # Back to original size
        self.subtitle_label.setFont(font)
        self.subtitle_label.setStyleSheet("color: #5E81AC; margin: 0px 0px 15px 0px;")
        frame_layout.addWidget(self.subtitle_label)
          # Add spacer before progress bar
        frame_layout.addSpacing(15)
        ...
        font = QFont("Arial", 10)  # Back to readable size
        self.status_label.setFont(font)
        self.status_label.setStyleSheet("color: #4C566A; margin: 10px 0px;")
        frame_layout.addWidget(self.status_label)
        
        # Add flexible spacer to push version to bottom
